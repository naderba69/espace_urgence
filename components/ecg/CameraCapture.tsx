  ...
  if (error) {
    return (
      <div className="flex flex-col items-center gap-3 rounded-2xl border border-line bg-surface p-6 text-center">
        ...
        <button onClick={onFileInstead} className="touch gap-2 rounded-xl bg-blue-600 px-5 py-3 font-bold text-white">
  ...
  return (
    <div className="relative overflow-hidden rounded-2xl border border-line bg-black">
      ...
      <svg viewBox="0 0 100 70" className="pointer-events-none absolute inset-0 h-full w-full" aria-hidden>
        <rect x="3" y="3" width="94" height="64" rx="3" fill="none" stroke="#1565c0" strokeWidth="0.6" strokeDasharray="2 1.5" opacity="0.9" />
        <line x1="33" y1="3" x2="33" y2="67" stroke="#1565c0" strokeWidth="0.3" opacity="0.5" />
        <line x1="66" y1="3" x2="66" y2="67" stroke="#1565c0" strokeWidth="0.3" opacity="0.5" />
        <line x1="3" y1="35" x2="97" y2="35" stroke="#1565c0" strokeWidth="0.3" opacity="0.5" />
      </svg>
      <div className="absolute inset-x-0 bottom-0 flex items-center justify-center gap-3 bg-gradient-to-t from-black/70 to-transparent p-4">
        <button onClick={capture}
          className="touch gap-2 rounded-2xl bg-blue-600 px-8 py-4 text-lg font-black text-white shadow-lg active:scale-95">
