...
import { Pill, Syringe, Brain, Droplets, Timer, Flame, Gauge, AlertTriangle, Baby, Scale, Wind, Stethoscope, Activity, ClipboardList, Printer, HeartPulse, Calculator, type LucideIcon } from "lucide-react";
import { useApp } from "@/components/Providers";
import { FavoriteButton } from "@/components/Chrome";
import type { Localized, ReviewMeta } from "@/data/types";

const ICONS = { Pill, Syringe, Brain, Droplets, Timer, Flame, Gauge, AlertTriangle, Baby, Scale, Wind, Stethoscope, Activity, ClipboardList, Printer, HeartPulse } satisfies Record<string, LucideIcon>;
...
export default function CalculatorCard({
  ...
  return (
    <div className="card flex h-full items-start justify-between gap-2 rounded-2xl border border-line bg-surface p-4 hover:border-blue-600 transition">
      <Link href={href} className="min-w-0 flex-1">
        <span className="mb-3 inline-flex rounded-xl bg-blue-600/15 p-3 text-blue-500">
