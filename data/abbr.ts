...
export const ABBREVIATIONS: AbbrEntry[] = [
  ...
  { abbr: "PAS", full: { fr: "Pression artérielle systolique", ar: "الضغط الانقباضي" }, detail: { fr: "Le chiffre haut. < 90 = hypotension.", ar: "الرقم الأعلى. أقل من 90 = انخفاض ضغط." } },
  { abbr: "PAD", full: { fr: "Pression artérielle diastolique", ar: "الضغط الانبساطي" }, detail: { fr: "Le chiffre bas.", ar: "الرقم الأدنى." } },
  { abbr: "PAM", full: { fr: "Pression artérielle moyenne", ar: "الضغط الشرياني المتوسط" }, detail: { fr: "PAM = (PAS + 2×PAD) / 3. Cible réanimation ≥ 65 mmHg.", ar: "= (انقباضي + 2×انبساطي)/3. هدف الإنعاش 65 أو أكثر." } },
  { abbr: "FC", full: { fr: "Fréquence cardiaque", ar: "معدل ضربات القلب" }, detail: { fr: "Normale : 60-100/min.", ar: "الطبيعي: 60-100/دقيقة." } },
  { abbr: "FR", full: { fr: "Fréquence respiratoire", ar: "معدل التنفس" }, detail: { fr: "Normale : 12-20/min. > 22 = signe d'alerte.", ar: "الطبيعي: 12-20/د. أكثر من 22 = علامة إنذار." } },
  { abbr: "SpO2", full: { fr: "Saturation pulsée en oxygène", ar: "تشبع الأكسجين النبضي" }, detail: { fr: "Cible 94-98 % (88-92 % en BPCO). < 90 % = urgence.", ar: "الهدف 94-98% (88-92% في الانسداد المزمن). أقل من 90% = طارئ." } },
  { abbr: "GCS", full: { fr: "Glasgow Coma Scale", ar: "مقياس غلاسكو للغيبوبة" }, detail: { fr: "Score de conscience 3-15 (yeux+verbal+moteur). ≤ 8 = intubation à discuter.", ar: "درجة الوعي 3-15. 8 أو أقل = فكّر بالتنبيب." } },
  ...
  { abbr: "STEMI", full: { fr: "SCA avec sus-décalage du ST", ar: "احتشاء بارتفاع مقطع ST" }, detail: { fr: "Occlusion artérielle → PCI < 120 min.", ar: "انسداد الشريان ← قسطرة أقل من 120 د." } },
  ...
  { abbr: "ACD", full: { fr: "Acido-cétose diabétique", ar: "حماض كيتوني سكري" }, detail: { fr: "Glycémie élevée + pH < 7,3 + cétones.", ar: "سكر مرتفع + pH أقل من 7.3 + كيتونات." } },
