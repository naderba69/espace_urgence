...
export interface Procedure {
  ...
  timeTarget?: Localized;   // objectif temporel affiché avec le chrono
  stepTimes?: number[];     // secondes cibles par étape
  meta: ReviewMeta;
}
...
export const procedures: Procedure[] = [
  {
    id: "iot-rsi",
    timeTarget: { fr: "≤ 30 s par tentative de laryngoscopie", ar: "≤ 30 ث لكل محاولة تنبيب" },
    stepTimes: [180, 60, 30, 60, 60, 120],
    ...
    steps: [
      ...
      { fr: "Intubation : laryngoscopie, vocalise ou non, 30 s max par tentative", ar: "تنبيب: رؤية الحبال، 30 أو أقل ث للمحاولة" },
  ...
  {
    id: "defibrillation",
    timeTarget: { fr: "Choc dès le défibrillateur prêt, interruptions < 10 s", ar: "صدمة فور جاهزية الصادم، انقطاعات < 10 ث" },
    stepTimes: [30, 30, 20, 10, 10],
  ...
  },
  {
    ...
    steps: [
      { fr: "Indication : ACR ou accès veineux impossible < 90 s — URGENT", ar: "استطباب: توقف قلب أو استحالة وريد خلال أقل من 90 ث — مستعجل" },
    ...
    nursing: [
      ...
      { fr: "Retirer < 24 h (idéal < 6 h) — infection.", ar: "أخرج خلال أقل من 24 س (المثلى أقل من 6 س) — عدوى." },
    ],
    meta: { sources: ["AHA ACLS accès IO", "SFAR"], lastReviewed: "2026-08" },
  },
  {
    id: "exsufflation",
    timeTarget: { fr: "Immédiat — ne pas attendre l'imagerie", ar: "فوري — لا تنتظر التصوير" },
    stepTimes: [30, 20, 30, 20, 60],
  ...
  {
    id: "neonat-ran",
    title: { fr: "Réanimation du nouveau-né (salle de naissance)", ar: "إنعاش الولدان في قاعة الولادة" },
    timeTarget: { fr: "Minute d'or : ventilation efficace dans les 60 s", ar: "الدقيقة الذهبية: تهوية فعالة خلال 60 ث" },
    stepTimes: [30, 15, 30, 60, 30, 30],
    equipment: [
      { fr: "Ballon autogonflable/T-piece + masques (tailles 0-1), aspiration", ar: "بالون ذاتي النفخ/‏T-piece + أقنعة مقاسات + شافطة" },
      { fr: "Laryngoscope + sondes 2,5-4 ; adrénaline 1:10 000 préparée", ar: "لارنجوسكوب + أنابيب 2.5-4؛ أدرنالين 1:10000 محضّر" },
      { fr: "Serviettes préchauffées, thermomètre, salle 23-25 °C", ar: "مناشف مسخّنة، مقياس حرارة، قاعة 23-25°" },
      { fr: "Cathéter ombilical (voie d'urgence) + ECG 3 dérivations si possible", ar: "قسطار سري (طريق إسعافي) + تخطيط 3 أقطاب إن أمكن" },
    ],
    steps: [
      { fr: "Naissance : sécher, stimuler, positionner, aspirer si besoin (≤ 30 s)", ar: "عند الولادة: تجفيف، تحفيز، تموضع، شفط عند الحاجة (≤ 30 ث)" },
      { fr: "Évaluer : respiration + FC (auscultation 6 s) — apnée ou FC < 100 → VENTILER", ar: "قيّم: تنفس + نبض (إصغاء 6 ث) — انقطاع نفَس أو نبض < 100 → تهوية" },
      { fr: "VPP 40-60/min : air 21 % (terme) ; vérifier le soulèvement du thorax", ar: "تهوية بضغط إيجابي 40-60/د بهواء الغرفة للتمام؛ تحقق من ارتفاع الصدر" },
      { fr: "FC < 60 malgré VPP efficace : O2 100 % + massage 3:1 (90+30/min)", ar: "نبض < 60 رغم تهوية فعالة: أكسجين 100% + تدليك 3:1 (90+30/د)" },
      { fr: "FC < 60 persistant : adrénaline 0,01-0,03 mg/kg IV/IO (0,1-0,3 mL/kg de 1:10 000)", ar: "نبض < 60 مستمر: أدرنالين 0.01-0.03 ملغ/كغ وريدي/عظمي (0.1-0.3 مل/كغ من 1:10000)" },
      { fr: "Réévaluer toutes les 30 s ; FC ≥ 100 + respiration → soins de transition", ar: "أعد التقييم كل 30 ث؛ نبض ≥ 100 مع تنفس → رعاية انتقالية" },
    ],
    nursing: [
      { fr: "Température 36,5-37,5 °C en continu (hypothermie = mortalité)", ar: "حرارة 36.5-37.5 باستمرار (انخفاضها يرفع الوفاة)" },
      { fr: "Documenter les temps : naissance, 1ʳᵉ VPP, adrénaline", ar: "وثّق الأزمنة: الولادة، أول تهوية، الأدرنالين" },
    ],
    checklist: {
      pre: [
        { fr: "Salle préchauffée + matériel vérifié", ar: "قاعة مسخّنة + معدات مفحوصة" },
        { fr: "Adrénaline diluée 1:10 000 en seringue", ar: "أدرنالين مخفف بمحقنة" },
        { fr: "Rôle annoncé (qui ventile / qui masse / qui chronomètre)", ar: "أدوار معلنة (من يهوّي/يدلكّ/يوقّت)" },
      ],
    },
