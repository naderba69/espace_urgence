...
export const protocolsP2: Protocol[] = [
  ...
  exams: {
    bio: [{ fr: "Troponine itérative, créatinine (produit de contraste)", ar: "تروبونين متكرر، كرياتينين (مادة ظل)" }],
    img: [{ fr: "Coronarographie (filière reperfusion)", ar: "قثطرة قلبية (مسار إعادة إرواء)" }],
    ecg: [{ fr: "ECG < 10 min, répéter si douleur persistante", ar: "تخطيط خلال 10 د، يُعاد إن استمر الألم" }],
  },
    steps: [
      { title: { fr: "ECG 12 dérivations immédiat (< 10 min) ; ± dérivations droites/postérieures si doute", ar: "تخطيط 12 اشتقاق فوراً (أقل من 10 د)؛ ± اشتقاقات يمنى/خلفية عند الشك" }, detail: { fr: "Sus-décalage ST ≥ 1 mm dans 2 dérivations contiguës = critère STEMI (adapter seuils âge/sexe).", ar: "ارتفاع ST 1 أو أكثر مم في اشتقاقين متجاورين = معيار الاحتشاء (عدّل حسب العمر/الجنس)." } },
      ...
      { title: { fr: "Douleur persistante & PAS > 100 : trinitrine SL 0,3-0,6 mg q5 min ×3", ar: "ألم مستمر وانقباضي أكثر من 100: نترات تحت اللسان كل 5 د ×3" } },
      { title: { fr: "O2 UNIQUEMENT si SpO2 < 90 % ; morphine si douleur réfractaire (2-4 mg titré)", ar: "أكسجين فقط إذا تشبع أقل من 90%؛ مورفين إن الألم مقاوم (2-4 ملغ معايرة)" } },
      { title: { fr: "STEMI : angioplastie primaire — objectif < 120 min du diagnostic (appel cardiologie/SAMU immédiat)", ar: "احتشاء بارتفاع ST: قسطرة أولية — الهدف أقل من 120 د من التشخيص (اتصال فوري بالقسطرة)" }, detail: { fr: "Si délai PCI > 120 min : thrombolyse < 12 h des symptômes si pas de CI.", ar: "إن تجاوز أجل القسطرة 120 د: حلّ الخثرة خلال أقل من 12 س من الأعراض دون موانع." } },
      { title: { fr: "NSTEMI : stratification troponine/risque → coronarographie < 24 h si haut risque", ar: "دون ST: تروبونين/خطر ← قسطرة أقل من 24 س إذا عالي الخطورة" } },
    ...
    keyPoints: [
      ...
      { fr: "Jamais de trinitrine si PAS < 90 mmHg ou suspicion d'IDM inférieur/droit.", ar: "لا نترات إذا انقباضي أقل من 90 أو اشتباه احتشاء سفلي/أيمن." },
    ],
    trajectory: [
      ...
      { when: { fr: "Évolution : choc cardiogénique (PAS < 90, marbrures)", ar: "تطوّر: صدمة قلبية (انقباضي أقل من 90، بقع زرقاء)" }, do: [
      ...
      { when: { fr: "Complication : OAP associé (orthopnée, crépitants, SpO₂ ↓)", ar: "مضاعفة: وذمة رئة مصاحبة (زلة في الاستلقاء، خراخر، هبوط التشبع)" }, do: [
        { fr: "Position assise, O₂, trinitrine SL si PAS > 110, furosémide 40 mg IV ; PAS de remplissage massif.", ar: "جلوس، أكسجين، نترات تحت اللسان إذا انقباضي أكثر من 110، فوروسيميد 40 ملغ وريدياً؛ لا تعويض واسع." },
      ]},
      { when: { fr: "Si pas d'amélioration à 30 min (douleur / récidive ECG)", ar: "إن لم يحدث تحسّن خلال 30 د (ألم / رجوع شذوذ التخطيط)" }, do: [
        { fr: "Refaire un ECG complet (± postérieures/droites) ; escalade vers coronarographie < 2 h.", ar: "أعد تخطيطاً كاملاً (± خلفية/يمنى)؛ تصعيد نحو قسطرة أقل من 2 س." },
      ]},
    ],
  ...
  exams: {
    bio: [{ fr: "BNP/NT-proBNP, gazos, créatinine/K+, troponine (cause)", ar: "BNP، غازات، كرياتينين/بوتاسيوم، تروبونين (السبب)" }],
    img: [{ fr: "Radio thorax (OAI + cardiomégalie), écho cardiaque", ar: "صورة صدر (ارتشاح + كبر قلب)، إيكو قلب" }],
    ecg: [{ fr: "ECG : FA / ischémie déclenchante", ar: "تخطيط: رجفان أذيني / إقفارية محرّضة" }],
  },
    steps: [
      ...
      { title: { fr: "CPAP dès que possible si détresse respiratoire avec signes de lutte (FR > 30)", ar: "CPAP بأسرع وقت عند ضيق التنفس مع علامات الجهد (FRأكثر من 30)" } },
      { title: { fr: "Trinitrine : 1-2 bouffées SL q5 min si PAS > 100 mmHg ; PSE si milieu médicalisé", ar: "نترات تحت اللسان 1-2 بخة كل 5 د إن انقباضي أكثر من 100" } },
    ...
    trajectory: [
      { when: { fr: "Réponse favorable à 30 min (SpO₂ ≥ 94 %, dyspnée ↓)", ar: "استجابة جيدة خلال 30 د (تشبع 94 أو أكثر%، تحسّن الزلة)" }, do: [
      ...
      { when: { fr: "Échec de la VNI à 15-30 min (épuisement, GCS ↓, SpO₂ < 90 %)", ar: "فشل VNI خلال 15-30 د (إنهاك، هبوط غلاسكو، تشبع أقل من 90%)" }, do: [
      ...
      { when: { fr: "Complication : hypotension / choc (PAS < 90)", ar: "مضاعفة: هبوط ضغط / صدمة (انقباضي أقل من 90)" }, do: [
  ...
  exams: {
    bio: [{ fr: "Glycémie, iono (Na), calcémie, toxiques, dosage antiépileptiques", ar: "سكر، شوارد (صوديوم)، كالسيوم، سموم، مستوى مضادات الصرع" }],
    img: [{ fr: "Scanner si foyer/1ʳᵉ crise ; IRM ± EEG si réfractaire", ar: "سكانر إن بؤرة/أولى نوبة؛ رنين ± تخطيط دماغ إن معند" }],
  },
    steps: [
      { title: { fr: "Protéger (décubitus latéral, dégagement), CHRONOMÉTRER la crise (> 5 min = état de mal)", ar: "احمِ (استلقاء جانبي، إبعاد الأخطار) ووقّت النوبة (أكثر من 5 د = حالة صرعية)" } },
    ...
    trajectory: [
      { when: { fr: "Pas d'arrêt après 2 doses de benzodiazépine (< 15 min)", ar: "لا توقف النوبة بعد جرعتين من البنزوديازيبين (أقل من 15 د)" }, do: [
      ...
      { when: { fr: "État de mal réfractaire (> 30 min)", ar: "حالة صرعية مقاومة (أكثر من 30 د)" }, do: [
  ...
  exams: {
    bio: [{ fr: "Gazométrie si sévère (pCO2 montante = fatigue)", ar: "غازات إن شديد (ثاني أكسيد صاعد = إنهاك)" }],
    img: [{ fr: "Radio thorax si suspicion pneumothorax/foyer", ar: "صورة صدر إن اشتباه استرواح/بؤرة" }],
  },
    steps: [
      ...
      { title: { fr: "Signes de danger de mort : FR > 25, FC > 110, SpO2 < 92, épuisement, confusion, paralysie respiratoire → réa/assistance ventilatoire", ar: "علامات خطر محدق: FRأكثر من 25، FCأكثر من 110، تشبعأقل من 92، إرهاق، تشوش، وهن تنفسي ← إنعاش" } },
    ],
    keyPoints: [
    ...
    trajectory: [
      { when: { fr: "Aggravation : épuisement, silence auscultatoire, SpO₂ < 90 %, bradycardie, GCS ↓", ar: "تدهور: إنهاك، صمت سمعي، تشبع أقل من 90%، بطء قلب، هبوط غلاسكو" }, do: [
  ...
  exams: {
    bio: [{ fr: "Lactates itératifs, hémocultures avant antibio, NFS/CRP, créatinine", ar: "لاكتات متكرر، مزارع دم قبل المضاد، تعداد/CRP، كرياتينين" }],
    img: [{ fr: "Recherche de la source (radio thorax, ECBU, écho…)", ar: "بحث عن المصدر (صدر، بول، إيكو…)" }],
    ecg: [{ fr: "Monitorage continu + diurèse horaire", ar: "مراقبة مستمرة + إدرار ساعي" }],
  },
    steps: [
      ...
      { title: { fr: "Noradrénaline PSE si PAM < 65 persistante (titrée à PAM 65)", ar: "نورأدرنالين مضخة إن بقي متوسط الضغط أقل من 65 (عايِر إلى 65)" } },
    ...
    keyPoints: [
      { fr: "Lactate ≥ 2 mmol/L + hypotension = alerte rouge (mortalité élevée).", ar: "لاكتات 2 أو أكثر + انخفاض ضغط = إنذار أحمر." },
      { fr: "La 1ère heure (« golden hour ») = antibiotiques + remplissage + source control.", ar: "الساعة الذهبية = مضاد حيوي + توسيع + ضبط مصدر." },
    ],
    trajectory: [
      { when: { fr: "PAS < 65 malgré noradrénaline ≥ 0,5 à 1 µg/kg/min", ar: "انقباضي أقل من 65 رغم نورأدرينالين 0.5 أو أكثر إلى 1 ميكروغ/كغ/د" }, do: [
      ...
      { when: { fr: "Lactates non clairants / oligurie à H2 à H4", ar: "لاكتات غير مرتدة / قلة بول بين الساعتين والرابعة" }, do: [
  ...
  exams: {
    bio: [{ fr: "Gazos/pH + bicarb, K+, glycémie, cétones, créatinine", ar: "غازات/pH + فحمات، بوتاسيوم، سكر، كيتون، كرياتينين" }],
    img: [{ fr: "Radio thorax si foyer infectieux déclenchant", ar: "صورة صدر إن بؤرة إنتانية محرّضة" }],
    ecg: [{ fr: "ECG : signes de kaliémie (T pointues…)", ar: "تخطيط: علامات بوتاسيوم (T مدببة…)" }],
  },
    steps: [
      { title: { fr: "Diagnostic : glycémie > 2,5 g/L (ou diabétique connu) + pH < 7,3 + cétones", ar: "تشخيص: سكر أكثر من 2.5 غ/ل + pHأقل من 7.3 + كيتونات" } },
      ...
      { title: { fr: "K+ AVANT insuline : si < 3,3 mmol/L → corriger K d'abord ; sinon PSE insuline rapide 0,1 UI/kg/h (pédiatrie 0,05-0,1)", ar: "قِس K قبل الأنسولين: إن أقل من 3.3 صحّحه أولاً؛ وإلا مضخة 0.1 وحدة/كغ/س (أطفال 0.05-0.1)" } },
      { title: { fr: "Baisse glycémique cible 0,5-1 g/L/h (~3 mmol/L/h)", ar: "هدف هبوط السكر 0.5-1 غ/ل/س" } },
      { title: { fr: "Quand glycémie < 2,5 g/L : ajouter G5 % pour poursuivre l'insuline jusqu'à fermeture du trou anionique", ar: "عند سكر أقل من 2.5: أضف G5% وواصل الأنسولين حتى تصحيح الحماض" } },
    ...
    trajectory: [
      { when: { fr: "K⁺ < 3,3 mmol/L (à l'entrée ou sous insuline)", ar: "بوتاسيوم أقل من 3.3 (عند الدخول أو تحت الأنسولين)" }, do: [
        { fr: "SUSPENDRE l'insuline ; KCl 20-40 mmol/h sous scope ECG ; reprendre l'insuline dès K⁺ ≥ 3,3.", ar: "أوقف الأنسولين؛ كلوريد البوتاسيوم 20-40 ميلي مكافئ/س تحت مراقبة؛ استأنف الأنسولين فور 3.3 أو أكثر." },
      ]},
      { when: { fr: "Glycémie < 2,5 g/L (14 mmol/L) sous insuline", ar: "سكر أقل من 2.5 غ/ل تحت الأنسولين" }, do: [
      ...
      { when: { fr: "Résolution (pH > 7,3, HCO₃⁻ > 15, cétose −)", ar: "الشفاء (pH أكثر من 7.3، بيكاربونات أكثر من 15، لا كيتونات)" }, do: [
  ...
  exams: {
    bio: [{ fr: "K+ de contrôle, créatinine, gazométrie", ar: "بوتاسيوم مراقبة، كرياتينين، غازات" }],
    ecg: [{ fr: "ECG itératif : T pointues → QRS large → sinusoïde", ar: "تخطيط متكرر: T مدببة ← QRS واسع ← شكل موجي" }],
  },
    steps: [
    ...
    trajectory: [
      ...
      { when: { fr: "K⁺ > 6,5 avec insuffisance rénale / anurie", ar: "بوتاسيوم أكثر من 6.5 مع قصور كلوي / انقطاع بول" }, do: [
  ...
  exams: {
    bio: [{ fr: "Plaquettes, ASAT/ALAT, LDH (HELLP), créatinine, protéinurie", ar: "صفيحات، أنزيمات كبد، LDH (HELLP)، كرياتينين، بيلة بروتينية" }],
    img: [{ fr: "Bien-être fœtal (RCGF/écho)", ar: "سلامة الجنين (تخطيط/إيكو)" }],
  },
    steps: [
      ...
      { title: { fr: "TA ≥ 160/110 persistante : labétalol, nicardipine ou urapidil IV selon protocole local", ar: "ضغط 160 أو أكثر/110 مستمر: لابيتالول أو نيكارديبين أو أورابيديل وريد حسب البروتوكول المحلي" } },
      ...
      { title: { fr: "Surveiller toxicité Mg : FR ≥ 16/min, réflexes présents, diurèse ≥ 25 mL/h ; antidote : gluconate de calcium 1 g IV", ar: "راقب سمية المغنيزيوم: تنفس 16 أو أكثر/د، منعكسات، بيلة 25 أو أكثر مل/س؛ الترياق: كالسيوم" } },
    ...
    trajectory: [
      ...
      { when: { fr: "PAS ≥ 160 malgré MgSO₄", ar: "انقباضي 160 أو أكثر رغم المغنيزيوم" }, do: [
      ...
      { when: { fr: "Surveillance post-partum (< 48 h)", ar: "مراقبة ما بعد الولادة (أقل من 48 س)" }, do: [
        { fr: "Poursuivre MgSO₄ 24 h : diurèse, réflexes rotuliens, FR ≥ 12/min ; gluconate de calcium prêt en antidote.", ar: "واصل المغنيزيوم 24 س: تحبور، منعكس الرضفة، تنفس 12 أو أكثر/د؛ غلوكونات الكالسيوم جاهزة كترياق." },
      ]},
    ],
