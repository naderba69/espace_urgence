...
export const protocolsP4: Protocol[] = [
  ...
  exams: {
    bio: [{ fr: "K+, digoxinémie si digoxine, TSH en différé", ar: "بوتاسيوم، مستوى ديجوكسين إن كان، درق لاحقاً" }],
    ecg: [{ fr: "ECG 12 dérivations : BAV, bradycardie sinusale", ar: "تخطيط 12 مشتقة: إحصار، بطء جيبي" }],
  },
    steps: [
      { title: { fr: "Confirmer : FC < 50 + signes (hypotension, altération conscience, douleur thoracique, OAP)", ar: "أكّد: نبض أقل من 50 + علامات (هبوط ضغط، تغير وعي، ألم صدري، وذمة)" } },
      { title: { fr: "Scope 12 dérivations + voie veineuse + O2 si SpO2 < 94 %", ar: "ECG 12 + مصل وريدي + أكسجين إذا التشبع أقل من 94%" } },
  ...
  exams: {
    bio: [{ fr: "K+ / Mg2+ (torsades) + hémoglobine (anémie déclenchante)", ar: "بوتاسيوم/مغنيزيوم (التواءات) + خضاب (فقر محرض)" }, { fr: "Troponine si douleur thoracique ; TSH en différé", ar: "تروبونين إن ألم صدري؛ درق لاحقاً" }],
    img: [{ fr: "Écho si signes d'insuffisance cardiaque ; angioscanner si suspicion EP", ar: "إيكو إن علامات قصور قلبي؛ سكانر مموّه إن شبهة انصمام" }],
    ecg: [{ fr: "ECG 12 dérivations : régulière/irrégulière, QRS fin/large — oriente tout", ar: "تخطيط 12 مشتقة: منتظم/غير منتظم، ضيق/واسع — يوجّه كل شيء" }],
  },
    steps: [
  ...
  exams: {
    bio: [{ fr: "D-dimères seulement si probabilité faible", ar: "دي-ديمير فقط إن احتمال منخفض" }, { fr: "Troponine + BNP (stratification) ; créatinine avant angioscanner ; NFS/plaquettes avant anticoagulation", ar: "تروبونين + BNP (تصنيف)؛ كرياتينين قبل السكانر؛ تعداد/صفيحات قبل التمييع" }],
    img: [{ fr: "Angioscanner thoracique ; écho (VD) ; écho-doppler veineux des membres", ar: "سكانر مموّه صدري؛ إيكو (بطين أيمن)؛ دوبلر وريدي أطراف" }],
    ecg: [{ fr: "ECG : tachycardie sinusale, S1Q3, BBD", ar: "تخطيط: تسرع جيبي، S1Q3، إحصار غصن أيمن" }],
  },
    steps: [
  ...
  exams: {
    bio: [{ fr: "Glycémie capillaire + veineuse de confirmation", ar: "سكر شعيري + وريدي للتأكيد" }, { fr: "HbA1c ; insuline/peptide C en différé (étiologie) ; cortisol si récidives", ar: "خضاب سكري؛ أنسولين/ببتيد C لاحقاً (السبب)؛ كورتيزول إن تكرر" }],
    img: [{ fr: "Scanner cérébral seulement si déficit focal persistant après correction", ar: "سكانر دماغ فقط إن عجز بؤري مستمر بعد التصحيح" }],
  },
    steps: [
    ...
    trajectory: [
      {
        when: { fr: "Si glycémie < 0,5 deux mesures de suite malgré le glucagon/G30", ar: "إذا السكر أقل من 0.5 مرتين رغم الغلوكاغون/G30" },
        do: [
  ...
  exams: {
    bio: [{ fr: "Glycémie + ionogramme + hémoglobine (hémorragie)", ar: "سكر + شاردة + خضاب (نزف)" }, { fr: "Troponine si douleur ; bêta-hCG si femme en âge de procréer (GEU)", ar: "تروبونين إن ألم؛ حمل إن امرأة بعمر إنجاب (حَمَل منتبذ)" }],
    img: [{ fr: "Écho cardiaque si souffle/cardiopathie ; scanner cérébral seulement si signes focaux", ar: "إيكو قلب إن نفخة/اعتلال؛ سكانر دماغ فقط إن علامات بؤرية" }],
    ecg: [{ fr: "ECG systématique : QT, Brugada, WPW, BAV", ar: "تخطيط لكل مريض: QT، بروغادا، وولف، إحصار" }],
  },
    steps: [
  ...
  exams: {
    bio: [{ fr: "CPK (rhabdomyolyse) + ionogramme + créatinine", ar: "CPK (انحلال ربيدات) + شاردة + كرياتينين" }, { fr: "Hémostase (CID) + transaminases + glycémie", ar: "تخثر (تخثر منتشر) + أنزيمات كبد + سكر" }],
    img: [{ fr: "Radio thorax si inhalation ; scanner cérébral si coma persistant", ar: "صورة صدر إن استنشاق؛ سكانر دماغ إن غيبوبة مستمرة" }],
    ecg: [{ fr: "ECG : troubles du rythme et de la repolarisation", ar: "تخطيط: اضطرابات نظم وإعادة استقطاب" }],
  },
    steps: [
      { title: { fr: "Confirmer : T°core ≥ 40 °C + troubles neuro (confusion, agitation, coma) dans contexte chaud/effort", ar: "أكّد: حرارة مركزية 40 أو أكثر° + علامات عصبية في سياق حر" } },
      ...
      { title: { fr: "Si très grave ou disponible : immersion en eau froide (10-15 °C) en remuant ; cible < 39 °C en 30 min", ar: "إذا شديد جداً: غمر بماء بارد 10-15°؛ هدف أقل من 39° خلال 30 د" } },
  ...
  exams: {
    img: [{ fr: "Diagnostic CLINIQUE : ne pas retarder la décompression ; écho/radio si stabilisé", ar: "تشخيص سريري: لا تأخير للسحب؛ إيكو/صورة إن مستقر" }],
  },
    steps: [
