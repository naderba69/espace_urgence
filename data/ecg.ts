...
export const ecgRhythms: EcgRhythm[] = [
  {
    ...
    kind: "sinus",
    caracteristiques: { fr: "FC 60-100/min, régulier ; onde P avant chaque QRS, PR 120-200 ms, QRS < 120 ms.", ar: "نبض 60-100/د منتظم؛ موجة P قبل كل QRS، PR 120-200، QRS أقل من 120 مللي ث." },
  ...
  },
  {
    ...
    kind: "tachysinus",
    caracteristiques: { fr: "FC > 100/min, régulier, P avant QRS, P identiques au sinus.", ar: "نبض أكثر من 100/د منتظم، P طبيعية قبل كل QRS." },
  ...
  },
  {
    ...
    kind: "bradysinus",
    caracteristiques: { fr: "FC < 60/min régulier, P + PR constants.", ar: "نبض أقل من 60/د منتظم، P وPR ثابتان." },
  ...
  },
  {
    ...
    kind: "tv",
    caracteristiques: { fr: "QRS larges > 120 ms réguliers, FC 120-250 ; avec ou sans pouls.", ar: "QRS عريض أكثر من 120 منتظم، نبض 120-250؛ بنبض أو بدونه." },
  ...
  },
  {
    ...
    kind: "stemi",
    caracteristiques: { fr: "Sus-ST ≥ 1 mm dans ≥ 2 dérivations contiguës (seuils âge/sexe), ± onde Q, T hyperaiguë.", ar: "ارتفاع ST 1 أو أكثر مم باشتقاقين متجاورين على الأقل ± موجة Q." },
    conduite: { fr: "Angioplastie primaire < 120 min ; aspirine + P2Y12 + anticoagulant ; douleur : morphine titrée.", ar: "قسطرة أولية أقل من 120 د؛ أسبرين + P2Y12 + تسييل؛ مورفين معايَر للألم." },
