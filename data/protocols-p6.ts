...
export const protocolsP6: Protocol[] = [
  ...
  exams: {
    bio: [{ fr: "Hb itératives, hémostase/INR (anticoagulants), bilan hépatique", ar: "خضاب متكرر، تخثر/INR (مميعات)، كبد" }],
    img: [{ fr: "Endoscopie < 24 h (diagnostic + thérapeutique)", ar: "تنظير خلال 24 س (تشخيص + علاج)" }],
  },
    steps: [
      ...
      { title: { fr: "Remplissage : cristalloïdes en bolus jusqu'à PAS ≥ 90 à 100 ; transfusion si Hb < 7 g/dL (8 si coronarien)", ar: "تعويض بلّوريات حتى ضغط 90 أو أكثر إلى 100؛ نقل دم إذا Hb أقل من 7 (8 إذا تاجي)" } },
      ...
      { title: { fr: "Endoscopie d'urgence ≤ (12 à 24 h, idéale 6 h si instable) — orienter vers un centre de soins intensifs", ar: "تنظير عاجل (12 أو أقل إلى 24 س، 6 س إذا غير مستقر) — وجّه لمركز مناظير" } },
    ],
    keyPoints: [
  ...
  exams: {
    bio: [{ fr: "Gaz du sang : hypercapnie + acidose respiratoire", ar: "غازات دم: فرط ثاني أكسيد + حماض تنفسي" }, { fr: "Ionogramme + NFS (polyglobulie) + CRP si infection", ar: "شاردة + تعداد (كثرة حمر) + CRP إن إنتان" }],
    img: [{ fr: "Radio thorax : pneumothorax, foyer, distension", ar: "صورة صدر: استرواح، بؤرة، انتفاخ" }],
    ecg: [{ fr: "ECG : cœur pulmonaire, troubles du rythme", ar: "تخطيط: قلب رئوي، اضطرابات نظم" }],
  },
    steps: [
    ...
    trajectory: [
      {
        when: { fr: "Aggravation : hypercapnie confusionnelle, FR > 30, SpO2 < 88 % malgré O2 titré", ar: "تفاقم: تشوش بفرط CO₂، FRأكثر من 30، تشبع أقل من 88% رغم الأكسجين المعيّن" },
        do: [
  ...
  },
  {
    ...
    category: "pediatrie",
    severity: "urgent",
    summary: { fr: "Crise convulsive chez l'enfant fébrile : rassurer, position latérale, BZD si > 5 min.", ar: "تشنج مع حمى عند الطفل: طمئن، وضعية جانبية، بنزوديازيبين إذا أكثر من 5 د." },
  exams: {
    bio: [{ fr: "Glycémie ; CRP ± bilan selon foyer", ar: "سكر؛ CRP ± حصيلة حسب البؤرة" }],
    img: [{ fr: "PL si signes méningés / < 12 mois atypique", ar: "بزل قطني إن علامات سحائية / < 12 شهراً غير نمطية" }],
  },
    steps: [
      { title: { fr: "Simple : < 15 min, généralisée, 6 mois à 5 ans, récupération complète et rapide en 1 h — vs complexe", ar: "بسيط: أقل من 15 د، معمم، 6 أشهر إلى 5 سنوات، شفاء كامل خلال ساعة — مقابل مركّب" } },
      ...
      { title: { fr: "Si > 5 min : benzodiazépine : midazolam buccal 0,5 mg/kg ou diazépam IR 0,5 mg/kg (max 10 mg)", ar: "إذا أكثر من 5 د: بنزوديازيبين: ميدازولام شدقي 0.5 ملغ/كغ أو ديازيبام شرجي 0.5 ملغ/كغ" } },
    ...
    trajectory: [
      {
        when: { fr: "Convulsion prolongée > 15 min (complexe) ou récidive dans la journée", ar: "تشنج ممدد أكثر من 15 د (مركّب) أو تكرار باليوم" },
        do: [
          ...
          { fr: "Éviter le statut : si 3ᵉ crise ou durée > 25 min → protocole état de mal pédiatrique.", ar: "إذا ثالثة أو أكثر من 25 د ← بروتوكول حالة الصرع للأطفال." },
        ],
      },
      {
  ...
  exams: {
    bio: [{ fr: "CPK + myoglobinurie (rhabdomyolyse) + K+ (lyse) + créatinine + troponine", ar: "CPK + ميوغلوبين بولي (انحلال ربيدات) + بوتاسيوم (انحلال) + كرياتينين + تروبونين" }],
    img: [{ fr: "Radios orientées par la chute/projection (trauma associé)", ar: "صور موجّهة بالسقوط/الاندفاع (رضّ مرافق)" }],
    ecg: [{ fr: "ECG + monitorage 24 h si haute tension ou symptomatique", ar: "تخطيط + مراقبة 24 س إن توتر عالٍ أو عرضي" }],
  },
    steps: [
  ...
  exams: {
    bio: [{ fr: "Protéinurie (BU + ratio) ; NFS/plaquettes (HELLP) ; transaminases + LDH", ar: "بروتين بول (شريحة + نسبة)؛ تعداد/صفيحات (HELLP)؛ أنزيمات كبد + LDH" }, { fr: "Créatinine + uricémie ; hémostase", ar: "كرياتينين + حمض بولي؛ تخثر" }],
    img: [{ fr: "Écho obstétricale + dopplers ; RCF (bien-être fœtal)", ar: "إيكو توليدي + دوبلر؛ مراقب جنين (سلامة الجنين)" }],
    ecg: [{ fr: "ECG si douleur thoracique ; écho si signes d'OAP", ar: "تخطيط إن ألم صدري؛ إيكو إن علامات وذمة رئة" }],
  },
    steps: [
      { title: { fr: "Suspicion : TA ≥ 160/110 chez femme enceinte ≥ 20 SA + céphalées/troubles visuels", ar: "اشتباه: ضغط 160 أو أكثر/110 عند حامل 20 أو أكثر أسبوع + صداع/اضطراب بصري" } },
      ...
      { title: { fr: "Antihypertenseur : labétalol bolus 20 mg IV (ou nicardipine/hydralazine selon protocole) — cible TA < 160/110", ar: "خافض ضغط: لابيتالول 20 ملغ دفعة — هدف ضغط أقل من 160/110" } },
