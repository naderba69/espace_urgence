...
export const protocolsP5: Protocol[] = [
  ...
  exams: {
    bio: [{ fr: "Glycémie + ionogramme + NFS", ar: "سكر + شاردة + تعداد" }, { fr: "Troponine/BNP si grade ≥ II (myocardite venimeuse)", ar: "تروبونين/BNP إن درجة ≥ II (عضلة قلب سمية)" }],
    img: [{ fr: "Écho cardiaque si signes d'insuffisance cardiaque", ar: "إيكو قلب إن علامات قصور" }],
    ecg: [{ fr: "ECG : troubles du rythme/repolarisation", ar: "تخطيط: اضطرابات نظم/إعادة استقطاب" }],
  },
    steps: [
    ...
    keyPoints: [
      ...
      { fr: "Tunisie : Androctonus australis (Sud : Gafsa, Gabès, Kébili, Médenine, Tataouine) = le plus dangereux ; Buthus occitanus (centre/nord). Pics juin-septembre. Enfant < 10 ans : risque majeur de grade III — hospitaliser TOUTE piqûre d'enfant, même d'apparence bénigne.", ar: "تونس: أندروكتونوس أستراليس (الجنوب: قفصة، قابس، قبلي، مدنين، تطاوين) = الأخطر؛ بوثوس أوكسيتانوس (الوسط/الشمال). الذروة جوان-سبتمبر. الطفل دون 10: خطر درجة III كبير — استشفِ كل لدغة طفل ولو بدت بسيطة." },
    ],
    trajectory: [
      {
  ...
  exams: {
    bio: [{ fr: "CO-Hb par co-oxymétrie, gazos, lactates, troponine", ar: "CO-Hb بقياس مشترك، غازات، لاكتات، تروبونين" }],
    ecg: [{ fr: "ECG : atteinte myocardique anoxique", ar: "تخطيط: أذية قلبية نقص أكسجة" }],
  },
    steps: [
      ...
      { title: { fr: "Si GCS ≤ 12, coma ou signes neurologiques → avis OXYBARIE (hyperbare) en discuter rapidement", ar: "إذا GCS 12 أو أقل أو علامات عصبية ← استشر chamber hyperbare بسرعة" } },
    ],
    keyPoints: [
      ...
      { fr: "Contexte tunisien : chauffe-eau à gaz butane dans salles de bain mal ventilées, kanoun/brasero en hiver, tentes de mariage chauffées au gaz, groupes électrogènes en coupure de courant — si PLUSIEURS personnes d'un même lieu ont céphalées/nausées, c'est du CO jusqu'à preuve du contraire : traiter TOUT le monde, pas seulement le plus grave.", ar: "سياق تونسي: سخانات بوتان في حمامات سيئة التهوية، الكانون شتاءً، خيام الأعراس المدفأة بالغاز، مولدات الكهرباء عند الانقطاع — إذا اشتكى عدة أشخاص من مكان واحد صداعاً/غثياناً فهو CO حتى يثبت العكس: عالج الجميع لا الأخطر فقط." },
    ],
    trajectory: [
      {
        ...
        do: [
          ...
          { fr: "Surveiller COHb en série (objectif < 5 %).", ar: "راقب COHb مسلسلاً (الهدف أقل من 5%)." },
        ],
      },
      {
      ...
      {
        when: { fr: "Récupération apparente puis dégradation neurologique à J+3 à J+21", ar: "تحسن ظاهري ثم تدهور عصبي بين يوم 3-21" },
        do: [
  ...
  exams: {
    bio: [{ fr: "Créatinine, protéinurie, glycémie", ar: "كرياتينين، بيلة بروتينية، سكر" }],
    img: [{ fr: "Fond d'œil, radio thorax si OAP, scanner si neuro", ar: "قاع عين، صورة صدر إن وذمة، سكانر إن عصبي" }],
    ecg: [{ fr: "ECG : HVG / ischémie", ar: "تخطيط: ضخامة بطين أيسر / إقفارية" }],
  },
    steps: [
      { title: { fr: "Justifier : TA ≥ 180/120 ET atteinte d'organe cible (neuro, rétine, rein, cœur)", ar: "برّر: ضغط 180 أو أكثر/120 وقصور عضوي (عصبي، شبكي، كلوي، قلبي)" } },
    ...
    keyPoints: [
      { fr: "Ne JAMAIS abaisser rapidement la TA (> 25 % PAM) en présence d'ischémie cérébrale/coronarienne.", ar: "لا تخفض الضغط بسرعة (أكثر من 25% متوسط) مع إقفار دماغي/تاجي." },
  ...
  exams: {
    bio: [{ fr: "CPK, K+, créatinine, calcémie, myoglobinurie", ar: "CPK، بوتاسيوم، كرياتينين، كالسيوم، بول ميوجلوبين" }],
    ecg: [{ fr: "ECG : hyperkaliémie", ar: "تخطيط: فرط بوتاسيوم" }],
  },
    steps: [
      ...
      { title: { fr: "NaCl 0,9 % abondant : 1-2 L bolus si majoration, diurèse cible ≥ 2 à 3 mL/kg/h", ar: "NaCl 0.9% غزير: 1-2 ل bolus؛ الهدف تحبور 2 أو أكثر إلى 3 مل/كغ/س" } },
      { title: { fr: "Mesurer K+, créat, CK au bas mot potassiumocytolyse ?", ar: "قِس K، كرياتينين، CK (خطر فرط بوتاسيوم)" } },
      { title: { fr: "Si urine foncée + K+ > 6 : traitement hyperkaliémie (voir protocole)", ar: "إذا بول قاتم + K أكثر من 6: بروتوكول فرط البوتاسيوم" } },
    ],
    keyPoints: [
    ...
    trajectory: [
      {
        when: { fr: "Insuffisance rénale aiguë malgré remplissage (oligurie < 0,5 mL/kg/h après 1-2 L)", ar: "قصور كلوي حاد رغم التعويض (قلة بول أقل من 0.5 مل/كغ/س بعد 1-2 ل)" },
        do: [
      ...
      {
        when: { fr: "Crush syndrome prolongé (membre sous poids > 4 h)", ar: "سحق طويل (طرف محشور أكثر من 4 ساعات)" },
        do: [
  ...
  exams: {
    bio: [{ fr: "Gaz du sang (acidose/hypoxémie) + ionogramme + glycémie", ar: "غازات دم (حماض/نقص أكسجة) + شاردة + سكر" }, { fr: "Toxiques/alcoolémie selon contexte", ar: "سموم/كحول حسب السياق" }],
    img: [{ fr: "Radio thorax : œdème/aspiration — peut se révéler tardivement", ar: "صورة صدر: وذمة/استنشاق — قد تظهر متأخرة" }],
    ecg: [{ fr: "ECG : hypothermie, QT, troubles du rythme", ar: "تخطيط: انخفاض حرارة، QT، اضطرابات نظم" }],
  },
    steps: [
    ...
    trajectory: [
      ...
      {
        when: { fr: "Hypothermie associée (< 35 °C)", ar: "نقص حرارة مصاحب (أقل من 35°)" },
        do: [
  ...
  exams: {
    bio: [{ fr: "T° centrale (thermomètre bas) + glycémie + ionogramme (K+ au réchauffement)", ar: "حرارة مركزية (ميزان منخفض) + سكر + شاردة (بوتاسيوم أثناء التدفئة)" }, { fr: "Hémostase (coagulopathie) + CPK + TSH (myxœdème) + alcoolémie", ar: "تخثر (اعتلال بارد) + CPK + درق (قصور درقي) + كحول" }],
    img: [{ fr: "Radio thorax si suspicion d'inhalation", ar: "صورة صدر إن شبهة استنشاق" }],
    ecg: [{ fr: "ECG : onde J d'Osborn, bradycardie, QT long", ar: "تخطيط: موجة J أوزبورن، بطء، QT طويل" }],
  },
    steps: [
      { title: { fr: "Température rectale de grade I (35-32), II (32-28), III (< 28)", ar: "حرارة شرجية: خفيف 35-32، متوسط 32-28، شديد أقل من 28" } },
      ...
      { title: { fr: "Si < 28 ou ACR : réchauffement interne urgent (perfusion 40 °C, irrigation péritonéale si possible)", ar: "إذا أقل من 28 أو توقف: تسخين داخلي مستعجل (سوائل 40°)" } },
    ],
    keyPoints: [
    ...
    trajectory: [
      {
        when: { fr: "ACR dans l'hypothermie (< 28 °C)", ar: "توقف القلب مع نقص حرارة (أقل من 28°)" },
        do: [
  ...
  exams: {
    bio: [{ fr: "Paracétamolémie systématique + salicylés", ar: "مستوى باراسيتامول لكل حالة + ساليسيلات" }, { fr: "Glycémie + ionogramme (trou anionique) + trou osmolaire (alcools) + créatinine", ar: "سكر + شاردة (فجوة أنيونية) + فجوة أسمولية (كحولات) + كرياتينين" }],
    img: [{ fr: "Radio abdomen si fer/lithium/conditionnement corporel suspectés", ar: "صورة بطن إن حديد/ليثيوم/بلع أكياس مشتبه" }],
    ecg: [{ fr: "ECG : QRS larges (bloqueurs sodiques), QT long (torsades)", ar: "تخطيط: مركّب واسع (حاصرات صوديوم)، QT طويل (التواءات)" }],
  },
    steps: [
    ...
    trajectory: [
      {
        ...
        do: [
          { fr: "Dosage sanguin paracétamol à 4 h ; si > 150 µg/mL → NAC IV (3 perfusions : 150 puis 50 puis 100 mg/kg).", ar: "جرعة باراسيتامول 4 س؛ إذا أكثر من 150 ← N-acetylcysteine وريدي." },
