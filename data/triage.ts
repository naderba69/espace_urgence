...
export const TRIAGE_CASES: TriageCase[] = [
  {
    ...
    triggers: [
      ...
      { fr: "Signes de gravité : PAS < 90, marbrures, sueurs profuses, OAP associé", ar: "علامات خطورة: انقباضي أقل من 90، بقع، تعرق غزير، وذمة رئة" },
      { fr: "ECG : ST+ (sus-décalage seuils V2-V3 : ≥ 2,5 mm H < 40 ans, ≥ 2 mm ≥ H40, ≥ 1,5 mm F ; 1 mm ailleurs) ou dépression V1-V3 (postérieur)", ar: "تخطيط: ‏ST+ (عتبات V2-V3: ‎2.5 أو أكثر مم رجال أقل من 40، ‎2 أو أكثر مم رجال 40 أو أكثر، ‎1.5 أو أكثر مم نساء؛ 1 مم في الباقي) أو نقصان V1-V3 (خلفي)" },
    ...
    immediate: [
      ...
      { fr: "Aspirine 250-300 mg + clopidogrel/ticagrélor selon protocole, if PAS > 110 : sublingual TNG", ar: "أسبيرين 250-300 ملغ + بلافيكس حسب البروتوكول؛ تحت اللسان إذا ضغط أكثر من 110" },
      { fr: "Analgésie titration morphinique si douleur persistante", ar: "معايرة مورفينية للألم المستمر" },
    ],
    downgrade: { fr: "Si ECG parfaitement normal + score HEART ≤ 3 + symptôme atypique > 1 h et PAS stable : ORANGE avec contrôle ECG à H1 et toutes les 3-4 h.", ar: "إذا تخطيط طبيعي + HEART‎ 3 أو أقل + ألم غير نمطي ومستقر: برتقالي مع تخطيط عند ساعة ثم كل 3-4 س." },
  ...
  },
  {
    ...
    priority: "P1",
    colorLabel: { fr: "ROUGE — thrombolyse/thrombectomie, fenêtre étroite (< 4 h 30)", ar: "أحمر — تحليل جلطة/استئصال خثرة، نافذة ضيقة أقل من 4.5 س" },
    triggers: [
      ...
      { fr: "Heure d'installation précise : < 4 h 30 = thrombolyse (Actilyse 0,9 mg/kg : 10 % bolus, 90 %/1 h)", ar: "وقت البداية بدقة: أقل من 4.5 س = التحليل (ألتيبلاز 0.9 ملغ/كغ)" },
    ...
    immediate: [
      ...
      { fr: "Position latérale de sécurité si GCS < 8 ; strict à jeun ; 2 VVP", ar: "وضع جانبي إذا غلاسكو أقل من 8؛ صيام تام؛ خطان وريديان" },
      { fr: "Si PAS > 185/110 et thrombolyse prévue : nicardipine (Loxen®) 1 mg/h départ", ar: "إن ضغط أكثر من 185/110 مع تحليل مرسوم: لوكسن 1 ملغ/س" },
    ],
    downgrade: { fr: "AIT (< 24 h avec récupération totale) = ORANGE avec consultation neurovasculaire < 24 h et bilan étiologique.", ar: "‏TIA: برتقالي بمراجعة عصبية وعائية أقل من 24 س." },
    protocolIds: ["avc"],
  ...
  },
  {
    ...
    triggers: [
      { fr: "SpO2 < 90 % sous O2, FR > 30 ou < 8, épuisement, tirage, silence auscultatoire, cyanose", ar: "‏SpO2 أقل من 90% تحت أكسجين، FR أكثر من 30 أو أقل من 8، إنهاك، صمت إصغائي، زرقة" },
      { fr: "Trouble de conscience associé (GCS < 12), signes de lutte", ar: "اضطراب وعي مرافق (غلاسكو أقل من 12)، علامات مقاومة" },
  ...
  },
  {
    ...
    triggers: [
      { fr: "qSOFA ≥ 2 : FR ≥ 22, PAS ≤ 100, GCS < 15 + foyer infectieux suspecté", ar: "‏qSOFA‎ 2 أو أكثر: FR‎ 22 أو أكثر، انقباضي 100 أو أقل، غلاسكو أقل من 15 + بؤرة مشتبهة" },
      { fr: "Marbrures, temps de recoloration > 3 s, oligoanurie, lactate > 2", ar: "بقع، إعادة تلوّن أكثر من 3 ث، قلة بيلة، لاكتات أكثر من 2" },
    ],
    immediate: [
      { fr: "Remplissage NaCl 30 mL/kg si PAS < 90 ou lactate ≥ 4 (par bolus 500 mL/15 min, réévaluer)", ar: "امتلاء 30 مل/كغ إن انقباضي أقل من 90 أو لاكتات 4 أو أكثر (دفعات 500 مل، أعد التقييم)" },
      ...
      { fr: "Noradrénaline PSE si PAS < 65 après remplissage (avoie centrale si possible)", ar: "نورأدرينالين إن متوسط أقل من 65 بعد الامتلاء (خط مركزي)" },
    ],
  ...
  },
  {
    ...
    triggers: [
      { fr: "Crise généralisée > 5 min OU répétées sans reprise de conscience = état de mal", ar: "نوبة معممة أكثر من 5 د أو متكررة دون استعادة وعي = حالة صرعية" },
    ...
    immediate: [
      { fr: "PLS, protection, ne RIEN mettre dans la bouche ; glycémie (corriger si < 0,8 g/L : G30 100 mL)", ar: "وضع جانبي، حماية، لا شيء بالفم؛ سكر (صحّح إن أقل من 0.8 غ/ل بـج30 100 مل)" },
  ...
  },
  {
    ...
    system: "neuro",
    title: { fr: "Trouble de la conscience (GCS < 15)", ar: "اضطراب الوعي (غلاسكو أقل من 15)" },
    priority: "P2",
    colorLabel: { fr: "ORANGE — devient ROUGE si GCS ≤ 8 ou signe de localisation", ar: "برتقالي — يصير أحمر إذا غلاسكو 8 أو أقل" },
    triggers: [
      { fr: "GCS ≤ 8 → protection des VAS (IOT si pas de réflexe toux/glôle) = ROUGE", ar: "غلاسكو 8 أو أقل → حماية المسالك = أحمر" },
    ...
    immediate: [
      ...
      { fr: "PLS si GCS < 12 ; protéger la nuque ; garder la tête surélevée 30°", ar: "وضع جانبي إن أقل من 12؛ رأس مرفوع 30°" },
      { fr: "Glucagon IM / G30 IV si hypoglycémie ; naloxone si myosis + RFR < 10", ar: "غلوكاغون/جلوكوز لنقص السكر؛ ناركان إن حدقة دبوس +FRأقل من 10" },
    ],
  ...
  },
  {
    ...
    triggers: [
      ...
      { fr: "Signes de choc : PAS < 90, FC > 110, sueurs froides, marbrures", ar: "علامات صدمة: انقباضي أقل من 90، نبض أكثر من 110، تعرق بارد" },
    ],
    immediate: [
  ...
  },
  {
    id: "polytrauma",
    system: "trauma",
    title: { fr: "Polytraumatisme (vitesses, chutes > 3 m, éjection)", ar: "متعدد الإصابات (سرعة، سقوط أكثر من 3م)" },
    priority: "P1",
    colorLabel: { fr: "ROUGE — mécanisme violent = CAT précoce s'il y a critère de gravité", ar: "أحمر — آليّة عنيفة تقرّر مبكراً" },
    triggers: [
      { fr: "Critères Vittel de gravité ou mécanisme : éjection, décès d'un occupant, enfoncement, vitesses > 60 km/h", ar: "معايير Vittel أو الآليّة: قذف، وفاة رفيق، ارتطام، سرعة أكثر من 60" },
      { fr: "Critères anatomiques : thorax instable, bassin instable, amputation, GCS < 13, PAS < 90, FR < 10 ou > 29", ar: "معايير تشريحية: صدر غير مستقر، حوض منزعزع، بتر، غلاسكو أقل من 13، ضغط أقل من 90" },
    ],
    immediate: [
  ...
  },
  {
    ...
    priority: "P2",
    colorLabel: { fr: "ORANGE — ROUGE si GCS ≤ 12 hémodynamiquement... signe de localisation, vomissements en jet, anisocorie", ar: "برتقالي — أحمر إذا غلاسكو 12 أو أقل أو علامات بؤرة أو قيء نافث" },
    triggers: [
      { fr: "Perte de connaissance + GCS 13-14 stable sans anticoagulant : ORANGE scanner < 4 h", ar: "فقدان وعي + غلاسكو 13-14 بدون مميعات: برتقالي ماسح أقل من 4 س" },
      { fr: "Anticoagulants/AOD + même petite perte = scanner quasi systématique (ORANGE haut)", ar: "مميعات + فقدان بسيط = ماسح شبه وجوبي" },
      { fr: "GCS ≤ 8, convulsion, anisocorie → ROUGE (scanner + IOT immédiate)", ar: "‏8 أو أقل، نوبات، لا تساوي → أحمر (ماسح + تنبيب)" },
    ],
    immediate: [
      { fr: "Surveillance GCS horaire/15 min ; glycémie ; TA cible mm ≥ 90 ; position tête surélevée 30°", ar: "راقب غلاسكو؛ سكر؛ ضغط انقباضي 90 أو أكثر؛ رأس 30°" },
  ...
  },
  {
    ...
    priority: "P1",
    colorLabel: { fr: "ROUGE si : face/mains, circulaire, SCB > 10 %, inhalation, enfant, électrique", ar: "أحمر إذا: وجه/يدان، دائري، مساحة أكثر من 10%، استنشاق، طفل، كهربائي" },
    triggers: [
      ...
      { fr: "SCB > 10 %, circulaire d'un membre, électrique haute tension", ar: "مساحة أكثر من 10%، حرق دائري، كهربائي عالي" },
    ],
    immediate: [
  ...
  },
  {
    ...
    priority: "P1",
    colorLabel: { fr: "ROUGE si SpO2 < 90 % ; sinon ORANGE avec traitement rapide", ar: "أحمر إذا SpO2 أقل من 90%؛ وإلا برتقالي بعلاج سريع" },
    triggers: [
      { fr: "Chuintements bilatéraux, orthopnée, sueurs, expectoration rosée, PCJ élevée", ar: "صفير ثنائي، تعذر اضطجاع، بلغم وردي" },
      { fr: "PAS > 140 → nitrés ; PAS < 90 → inotrope (dobutamine) ; trouble du rythme rapide", ar: "انقباضي أكثر من 140 نترات؛ أقل من 90 دوبوتامين؛ تسرع نظم" },
    ],
    immediate: [
      ...
      { fr: "Furosémide 40-80 mg IVL si PAS > 110 et oligurie ; TNG/immeuble nitré si PAS > 140", ar: "لازيليكس 40-80 ملغ بطيء إن انق. أكثر من 110 وقلة بيلة؛ ترينيترين إن أكثر من 140" },
  ...
  },
  {
    ...
    priority: "P1",
    colorLabel: { fr: "ROUGE si saignement actif ou < 34 SA ou présentation haute", ar: "أحمر إذا نزيف نشط أو أقل من 34 أسبوع أو مقدمة علوية" },
    triggers: [
      { fr: "Saignement rouge vif > 500 mL ou choc à la délivrance", ar: "نزيف أحمر أكثر من 500 مل أو صدمة بعد الانفصال" },
  ...
  },
  {
    ...
    immediate: [
      ...
      { fr: "Glycémie ; protected airway si GCS < 8 ; décontamination cutanée si contact", ar: "سكر؛ حماية مسالك إن أقل من 8؛ تطهير جلدي" },
  ...
  },
  {
    ...
    priority: "P2",
    colorLabel: { fr: "ORANGE — ROUGE si purpura, stridor, déshydratation sévère, ou < 3 mois avec T° > 38", ar: "برتقالي — أحمر إذا بقع أرجوانية أو صرير أو تجفاف شديد أو أقل من 3 أشهر بحمى" },
    triggers: [
    ...
    immediate: [
      { fr: "Paracétamol si bien toléré ; O2 si SpO2 < 94 % ; ne PAS baisser la T° à tout prix si n'épuise pas", ar: "باراسيتامول إن تُحمّل جيداً؛ أكسجين إن SpO2أقل من 94%؛ لا تخفض الحرارة بأي ثمن" },
  ...
  },
  {
    ...
    triggers: [
      { fr: "Gluid < 0,8 g/L + sueurs, tremblements, confusion ou coma ; diabétique sous insuline ou EO", ar: "‏أقل من 0.8 غ/ل + تعرق، رعاش، ارتباك؛ مريض سكري بإنسولين" },
    ],
    immediate: [
  ...
  },
  {
    ...
    triggers: [
      { fr: "Trouble de conscience, brûlure d'entrée/sortie, ou haute tension (> 1000 V) → ROUGE avec ECG impératif", ar: "فقدان وعي، نقاط دخول/خروج، أو توتر أكثر من 1000 فولت → أحمر بتخطيط واجب" },
  ...
  },
  {
    ...
    triggers: [
      { fr: "PAllor, puis douleur, puis abolition du pouls distal = ROUGE chirurgie vasculaire < 6 h", ar: "شحوب ثم ألم ثم غياب نبض قاصٍ = أحمر جراحي أقل من 6 س" },
    ],
    immediate: [
  ...
  },
  {
    ...
    triggers: [
      { fr: "Fièvre > 38,3 + frissons chez immunodéprimé, chimiothérapie < 15 j, splénectomie", ar: "حمى أكثر من 38.3 بمناعي، علاج كيميائي أقل من 15 يوماً، استئصال طحال" },
    ],
    immediate: [
...
export const PRIORITY_META: Record<TriagePriority, { cls: string; label: Localized; delay: Localized }> = {
  P1: {
    ...
    delay: { fr: "prise en charge immédiate (< 15 min)", ar: "تدخل فوري (أقل من 15 د)" },
  },
  P2: {
    cls: "bg-orange-500",
    label: { fr: "P2 — URGENT", ar: "‏P2 — عاجل" },
    delay: { fr: "délai cible < 60 min, réévaluation horaire", ar: "مهلة أقل من 60 د، إعادة تقييم كل ساعة" },
  },
  P3: {
    cls: "bg-teal-600",
    label: { fr: "P3 — PEUT ATTENDRE", ar: "‏P3 — بإمكانه الانتظار" },
    delay: { fr: "délai cible < 4 h", ar: "مهلة أقل من 4 س" },
  },
};
