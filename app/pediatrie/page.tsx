...
export default function PediatriePage() {
  return (
    <HubPage
      ...
      {...hubProps(["acr-pediatrique", "deshydratation-enfant"], ["adrenaline", "amiodarone", "paracetamol", "midazolam"])}
    >
      <section className="card rounded-2xl border border-line bg-surface p-4">
        <h2 className="mb-2 font-bold text-blue-500"><T fr="Constantes par âge (rappel)" ar="الثوابت حسب العمر (تذكير)" /></h2>
      ...
      <section className="card rounded-2xl border border-blue-600/40 bg-blue-600/10 p-4">
        <h2 className="mb-2 font-bold text-blue-500"><T fr="Formules rapides" ar="صيغ سريعة" /></h2>
        ...
        <Link href="/calculateurs/poids-pediatrique" className="mt-3 inline-block rounded-xl bg-blue-600 px-5 py-2 font-bold text-white">
