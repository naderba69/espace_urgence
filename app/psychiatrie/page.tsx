...
export default function PsychiatriePage() {
  return (
    <HubPage
      ...
      {...hubProps(["agitation-aigue"], ["midazolam", "diazepam", "naloxone", "acetylcysteine", "flumazenil"])}
    >
      <section className="card rounded-2xl border border-line bg-surface p-4">
        <h2 className="mb-2 font-bold text-blue-500"><T fr="Évaluation rapide du risque suicidaire" ar="تقييم سريع لخطر الانتحار" /></h2>
